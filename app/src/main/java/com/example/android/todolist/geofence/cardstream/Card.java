package com.example.android.todolist.geofence.cardstream;/*
...
public class Card
{
    ...
    public static class Builder
    {
        ...
        public Card build(Activity activity) {
            ...
            // Inflating the card.
            ViewGroup cardView = (ViewGroup) inflater.inflate(mCard.mLayoutId, (ViewGroup) activity.findViewById(R.id.card_stream), false);
